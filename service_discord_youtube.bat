...
set SRVCNAME=Pajiro:BOOSTCORD

net stop "%SRVCNAME%"
sc delete "%SRVCNAME%"
sc create "%SRVCNAME%" binPath= "%BIN%winws.exe %ARGS%" DisplayName= "Pajiro:BOOSTCORD DPI bypass : winws1" start= auto
sc description "%SRVCNAME%" "Pajiro:BOOSTCORD DPI bypass software"
sc start "%SRVCNAME%"
